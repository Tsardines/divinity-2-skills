...
class Scoun extends Component {
  ...
  componentWillMount() {
    fetch('https://api.myjson.com/bins/142ew4')
    .then(res => res.json())
    .then(data => {
  ...
  render() {
    ...
    return (
      ...
      <div className="scoun-wrap">

        <span className="skill-title"><h1>Scoundrel</h1></span>
